...
class Rex
{
     ...
     */
    public function view($template = null, $datas = [])
    {
     ...
     * @param array  $datas    Viewbag
     */
    public function partial_view($view = null, $datas = [])
    {
        if (isset($datas)) {
            global $data;
            $data = [];
     ...
     */
    public function call($controller, $args = [])
    {
        ...
        if (file_exists($controller_file)) {
            ...
            if (method_exists($cls, $method) && is_callable([$cls, $method])) {
                call_user_func_array([$cls, $method], $args);
            } else {
